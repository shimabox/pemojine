...
class EmojiTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function provider_for_getSupportVendorByShortName()
    {
        return [
            ...
            ['⊛ pirate flag',                 ['Apple', 'Google', 'Twitter', 'EmojiOne', 'Samsung', 'Windows']],
            ['',                              []],
            [0,                               []],
            [null,                            []],
        ];
    ...
    public function provider_for_getOtherSupportVendor()
    {
        return [
            ...
            ['EmojiOne', '⊛ pirate flag',                 ['Apple', 'Google', 'Twitter', 'Samsung', 'Windows']],
            ['Facebook', '⊛ pirate flag',                 ['Apple', 'Google', 'Twitter', 'EmojiOne', 'Samsung', 'Windows']],
            ['Apple',    '',                              []],
            ['Google',   0,                               []],
            ['Twitter',  null,                            []],
        ];
